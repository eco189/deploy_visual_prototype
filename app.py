#                      Запускается, только если открыть терминал из папки Conda_virtual
...
def load_embeddings(file_name='data/item_embeddings.pkl'):  # было file_name='item_embeddings.pkl'
    """
